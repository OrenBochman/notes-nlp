...
> okay so today i'd like to talk about uh automatic speech recognition
...
Here is a lesson outline in a markdown unnumbered list format, based on the sources:
