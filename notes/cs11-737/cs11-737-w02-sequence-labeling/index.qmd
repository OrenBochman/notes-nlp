...
*   @sang2003introduction [CoNLL 2002/2003 Language Independent Named Entity Recognition](https://aclanthology.org/W03-0419.pdf) [dataset](https://www.clips.uantwerpen.be/conll2003/ner/)
...
*   @hu2020xtreme [XTREME: A Massively Multilingual Multi-task Benchmark for Evaluating Cross-lingual Generalization](https://arxiv.org/pdf/2003.11080) [dataset](https://github.com/google-research/xtreme)
    *   This paper introduces a benchmark for evaluating cross-lingual generalization across multiple tasks and languages.
*   @liang-etal-2020-xglue [XGLUE: A New Benchmark Dataset for Cross-lingual Pre-training, Understanding and Generation](https://aclanthology.org/2020.emnlp-main.484/) [presentation](https://slideslive.com/38938792) [dataset](https://microsoft.github.io/XGLUE/)
...
The lesson also refer to the Universal Dependencies Treebank, Udify, and Stanza as resources for multilingual NLP tasks which are linked below.
...
- [LTI LangID Corpus](https://www.cs.cmu.edu/~ralf/langid.html)
...
- [Cross-lingual Sentence Classification](https://github.com/ccsasuke/adan)
- [Universal Dependencies/POS Tags](https://universaldependencies.org/)
- [CoNLL NER Tasks](https://www.clips.uantwerpen.be/conll2003/ner/)
