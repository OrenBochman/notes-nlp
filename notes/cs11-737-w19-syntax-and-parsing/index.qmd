...
*   **Chaudhary, Aditi, et al. "Automatic Extraction of Rules Governing Morphological Agreement." EMNLP 2020**. This paper is related to extracting morphological agreement rules using dependency relations.
*   **Ahmad, Wasi Uddin, et al. "On difficulties of cross-lingual transfer with order differences: A case study on dependency parsing." NAACL 2019**. This paper discusses challenges in cross-lingual transfer due to word order differences.
*   **He, Junxian, et al. "Cross-lingual syntactic transfer through unsupervised adaptation of invertible projections." ACL 2019**. This paper is about cross-lingual syntactic transfer using unsupervised adaptation of invertible projections.
*   **Meng, Tao, Nanyun Peng, and Kai-Wei Chang. "Target language-aware constrained inference for cross-lingual dependency parsing." EMNLP 2019**. This paper focuses on target language-aware constrained inference for cross-lingual dependency parsing.
*   **Chu and Liu 1965, Edmonds 1967**. These papers are related to the Chu-Liu-Edmonds algorithm.
*   **Kipperwasser and Goldberg 2016**. This paper concerns Sequence Model Feature Extractors.
*   **Dozat and Manning 2017**. This paper discusses the BiAffine Classifier.
*   **Yamada & Matsumoto 2003, Nivre 2003**. These papers describe Arc Standard Shift-Reduce Parsing.
...
*   **Chaudhary, Sheikh, Mortensen, Anastasopoulos, Neubig. "AutoLEX: An Automatic Framework for Linguistic Exploration." In Submission**.
*   **Pratapa, Anastasopoulos, RIjhwani, Chaudhary, Mortensen, Sheikh, Neubig, Tsvetkov. "Evaluating the Morphosyntactic Well-formedness of Generated Texts." EMNLP 2020**.
