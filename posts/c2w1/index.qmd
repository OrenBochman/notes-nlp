...
![course banner](/images/Course-Logo-2-3.webp){.column-margin}
:::
...
1. Identify the misspelled word
  - When identifying the misspelled word, you can check whether it is in the vocabulary. 
    If you don't find it, then it is probably a typo.
