...
Subtitle: Review
Categories: [Paper, Review, NLP, LSTM, Seq2Seqs, RNN]
...
![Literature Review](cover.jpg){.column-margin}
...
{{< video https://www.youtube.com/watch?v=0OaEv1a5jUM >}}
...
This paper is a bit heavy on the technical side. But if you are still here, you may enjoy this podcast reviewing the paper. Though AI generated I found it quite useful to get oriented with the paper and understand that the experiments the authors run to validate this new architectures.
...
- In @vid-01 Yannic Kilcher covers the paper in his youtube channel. He does a great job of explaining the paper in a way that is easy to understand. Kilcher is all too human, he makes many mistakes, stresses opinions over facts. If you don't mind all that he is a great resource for understanding the paper. I find he rubs me the wrong way but at least I find this motivating to do better in my own reviews!
