...
```{python}
#| colab: {base_uri: https://localhost:8080/, height: 493}
#| colab_type: code
import os 
...
```{python}
#| colab: {base_uri: https://localhost:8080/, height: 289}
#| colab_type: code
...
```{python}
#| colab: {base_uri: https://localhost:8080/, height: 799}
#| colab_type: code
#| scrolled: true
...
```{python}
#| colab: {base_uri: https://localhost:8080/, height: 850}
#| colab_type: code
