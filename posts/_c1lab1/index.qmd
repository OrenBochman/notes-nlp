...
jupyter: python3
---
![course banner](img/course-banner.jpg){.column-margin group="slides"}

# Assignment 1: Logistic Regression

Welcome to week one of this specialization. You will learn about logistic regression. Concretely, you will be implementing logistic regression for sentiment analysis on tweets. Given a tweet, you will decide if it has a positive sentiment or a negative one. 
...
![Figure 1](img/sigmoid_plot.jpg){style="width:300px;height:200px;" group="slides"}
