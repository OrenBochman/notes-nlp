...
## Video 1 : Week 3 Overview {#sec-video1-week3-overview}

![week-3](img/V1-001-week-3.png){.column-margin}
...
![question-answering](img/V1-002-question-answering.png){.column-margin}
...
![tl](img/V1-003-tl.png){.column-margin}


![classical-training](img/V1-004-classical-training.png){.column-margin}

![transfer-learning](img/V1-005-transfer-learning.png){.column-margin}

![transfer-learning-tasks](img/V1-006-transfer-learning-tasks.png){.column-margin}
...
![goals](img/V1-007-goals.png){.column-margin}
...
## Video 2 : Transfer Learning in NLP {#sec-video2-transfer-learning-nlp}

![transfer-learning-options](img/V2-010-transfer-learning-options.png){.column-margin}

![tl-general-purpose](img/V2-011-tl-general-purpose.png){.column-margin}

![tl-features-vs-fine-tuning](img/V2-012-tl-features-vs-fine-tuning.png){.column-margin}

![tl-fine-tuning](img/V2-013-tl-fine-tuning.png){.column-margin}
 
![tl-pretain-data-performance](img/V2-014-tl-pretain-data-performance.png){.column-margin}

![tl-pretain-data-supervision](img/V2-015-tl-pretain-data-supervision.png){.column-margin}

![tl-pretain-unsupervised](img/V2-016-tl-pretain-unsupervised.png){.column-margin}


![tl-pretrain-selfsupervised](img/V2-017-tl-pretrain-selfsupervised.png){.column-margin}

![tl-pretrain-selfsupervised](img/V2-018-tl-pretrain-selfsupervised.png){.column-margin}

![tl-per-task-fine-tuning](img/V2-019-tl-per-task-fine-tuning.png){.column-margin}


![tl-summary](img/V2-020-tl-summary.png){.column-margin}
...
## Video 3 : ELMo, GPT, BERT, T5 {#sec-video3-elmo-gpt-bert-t5}

![outline](img/V3-030-outline.png){.column-margin}
<hr>

![CBOW-fixed-window](img/V3-031-CBOW-fixed-window.png){.column-margin}
...
![CBOW-issues](img/V3-032-cbow-issues.png){.column-margin}

![ELMo-solution](img/V3-033-elmo-solution.png){.column-margin}

![ELMo-RNN](img/V3-034-elmo-rnn.png){.column-margin}

![GPT-unidirectional](img/V3-035-GPT-unidirectional.png){.column-margin}

![BERT](img/V3-036-bert.png){.column-margin}

![multi-mask](img/V3-037-multi-mask.png){.column-margin}

![BERT-pre-training](img/V3-038-BERT-pre-training.png){.column-margin}


![t5-encoder-decoder](img/V3-039-t5-encoder-decoder.png){.column-margin}
...
![t5-text-to-text](img/V3-041-t5-text-to-text.png){.column-margin}

Here is an illustration of how T5 works:

![question](img/V3-042-question.png){.column-margin}


![summary](img/V3-043-summary.png){.column-margin}

So we can now flesh out the table

## Video 4 : BERT Bidirectional Encoder Representations from Transformers {#sec-video4-bert}

![BERT-outline](img/V4-050-bert-outline.png){.column-margin}

![BERT-question](img/V4-050-bert-question.png){.column-margin}


![BERT-summary](img/V4-050-bert-summary.png){.column-margin}
...
![BERT](img/V4-051-bert.png){.column-margin}

![BERT-spec](img/V4-052-bert-spec.png){.column-margin}
 
 Spec and features:

![BERT-pre-training](img/V4-053-bert-pre-training.png){.column-margin}

## Video 5 : BERT Objective {#sec-video5-bert-objective}

![BERT-outline](img/V5-060-BERT-outline.png){.column-margin}
...
![BERT-the-input](img/V5-061-BERT-the-input.png){.column-margin}
...
![BERT-the-output](img/V5-062-BERT-the-output.png){.column-margin}
...
![BERT-objectives](img/V5-063-BERT-objectives.png){.column-margin}

The BERT objective is defined as follows: 


![BERT-summary](img/V5-064-BERT-summary.png){.column-margin}

## Video 6: Fine tuning BERT {#sec-video6-fine-tuning-bert}

![BERT-fine-tuning-outline](img/V6-070-BERT-fine-tuning-outline.png){.column-margin}

Once you have a pre-trained model, you can fine tune it on different tasks. 


![inputs](img/V6-071-inputs.png){.column-margin}
...
![summary](img/V6-072-summary.png){.column-margin}


## Video 7: Transformer: T5

![t5-outline](img/V7-073-t5-outline.png){.column-margin}

![t5-text-to-text](img/V7-074-t5-text-to-text.png){.column-margin}

![T5-transformer](img/V7-075-T5-transformer.png){.column-margin}
...
![T5-architecture](img/V7-076-T5-architecture.png){.column-margin}
...
## Video 8: Lecture Multi-Task Training Strategy {#sec-video8-multi-task-training-strategy}

![T5-architecture](img/V8-080-T5-architecture.png){.column-margin}

![T5-summary](img/V8-081-T5-summary.png){.column-margin}

![T5-multi-task-training](img/V8-082-T5-multi-task-training.png){.column-margin}
...
![io-format](img/V8-083-io-format.png){.column-margin}

![multi-task-training](img/V8-084-multi-task-training.png){.column-margin}

![data-training-strategy](img/V8-085-data-training-strategy.png){.column-margin}

![unfreezing-adapter-layers](img/V8-086-unfreezing-adapter-layers.png){.column-margin}

![question](img/V8-087-question.png){.column-margin}

![fine-tuning](img/V8-088-fine-tuning.png){.column-margin}

You can see how fine tuning on a specific task could work even though you were pre-training on different tasks.

## Video 9: GLUE Benchmark {#sec-video9-glue-benchmark}

![GLUE-evaluation](img/V9-090-GLUE-evaluation.png){.column-margin}

![GLUE-tasks](img/V9-091-GLUE-tasks.png){.column-margin}

![GLUE](img/V9-092-GLUE.png){.column-margin}
...
## Video 10: Question Answering {#sec-video10-question-answering}

![BERT-feed-forward-block](img/V9-093-BERT-feed-forward-block.png){.column-margin}
You will be implementing an encoder this week. Last week you implemented the decoder. So here it is: 

![BERT-encoder-Block](img/V9-094-BERT-encoder-Block.png){.column-margin}

![BERT-blocks](img/V9-095-BERT-blocks.png){.column-margin}

![q&a-data-example](img/V9-096-q&a-data-example.png){.column-margin}

![q&a-with-t5](img/V9-097-q&a-with-t5.png){.column-margin}

![t5](img/V9-098-t5.png){.column-margin}

![t5-question](img/V9-099-t5-question.png){.column-margin}
