...
- Another challenge is that the target language may require words or even grammatical constructs e.g. gender and gender agreement that are lacking in the source language. These are [floating constraints](../1997-floating-contraints/index.qmd) c.f. (@mckeown1997floating) that the model needs to propagate through the translation process.
