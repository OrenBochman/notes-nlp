...
categories: [NLP, Paper, Attention, Deep learning, Review, Podcast]
#draft: true
---
...
The earlier work in @bahdanau2016neuralmachinetranslationjointly the authors used a bidirectional RNN with (GRUs) as the encoder and a unidirectional RNN with GRUs as the decoder. The attention mechanism dynamically aligned source words with the target words during decoding. 
