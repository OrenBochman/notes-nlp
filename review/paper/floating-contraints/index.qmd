...
- An Architecture for Lexical Choice
    ...
    - Presents the two tasks of lexical choice: syntagmatic decisions (determining thematic structure) and paradigmatic decisions (choosing specific words).
...
- The idea of constrainst is deeply embedded in Linguistics. The two type that immediately come to mind are:
...
- Other constrainst that I did not have to deal with as often are pragmatics and these are resolved from the state of the world or common sense knowledge.
...
We would realy like it to be good with grammar 
