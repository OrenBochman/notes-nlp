...
subtitle: Review
categories: [Review, Book, NLP, Sentiment Analysis, Sentiment Analysis, Linguistic Inquiry and Word Count]
---

![cover](cover.jpg){.column-margin group="slides"}
...
- One of the gems I learned on that job was that [everything in the corpus can be provide invaluable information if we only know how to index it]{.mark}. 
